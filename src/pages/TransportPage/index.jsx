      ...
      <div className='p-2'>
        ...
        <div className='bg-white shadow-md rounded-lg p-2 m-2 text-center'>
          ...
          <div className='grid grid-cols-2'>
            <p>
              <strong>Vehicle Type:</strong> {transport.vehicle_type}
            </p>
            <p>
              <strong>Fuel Consumption:</strong> {transport.fuel_consumption}{' '}
              L/100km
            </p>
            <p>
              <strong>Fuel Type:</strong> {transport.fuel_type}
            </p>
            <p>
              <strong>Company Tax:</strong> {transport.company_tax}
            </p>
            <p>
              <strong>Capacity:</strong> {transport.capacity}
            </p>
            <p>
              <strong>Maintenance Cost:</strong> {transport.maintenance_cost}
            </p>
          </div>
          <hr className='my-2' />
        </div>
        <hr className='my-2' />
        <h2 className='text-2xl font-bold my-4 text-emerald-300 text-center'>
          Transport Routes
        </h2>
        <hr className='my-2' />
